...
//long WINAPI MonitorFromPoint(long pt,long dwFlags);
//long WINAPI MonitorFromRect(long lprc,long dwFlags);
...
//long WINAPI OpenRaw(long lpFileName,long ulFlags,long pvContext);
//long WINAPI ReadRaw(long pfExportCallback,long pvCallbackContext,long pvContext);
//long WINAPI WriteRaw(long pfImportCallback,long pvCallbackContext,long pvContext);
//VOID WINAPI CloseRaw(long pvContext);
//long WINAPI QueryRecoveryAgents(long lpFileName,long AgentCount,long RecoveryAgentInformation);
...
//long WINAPI LogonUser(long lpszUsername,long lpszDomain,long lpszPassword,long dwLogonType,long dwLogonProvider,long phToken);
//long WINAPI ImpersonateLoggedOnUser(long hToken);
...
//long WINAPI IsTokenRestricted(long TokenHandle);
...
//API(ImpersonateLoggedOnUser,advapi32)
...
long WINAPI GetCurrentProcess(long);
...
//long WINAPI SetThreadIdealProcessor(long hThread,long dwIdealProcessor);
...
//long WINAPI QueueUserAPC(long pfnAPC,long hThread,long dwData);
//long WINAPI IsDebuggerPresent(long);
...
//long WINAPI IsProcessorFeaturePresent(long ProcessorFeature);
...
//long WINAPI MapViewOfFileVlm(long hFileMappingObject,long dwDesiredAccess,long ulOffset,long ulNumberOfBytesToMap,long lpBaseAddress);
long WINAPI FlushViewOfFile(long lpBaseAddress,long dwNumberOfBytesToFlush);
long WINAPI UnmapViewOfFile(long lpBaseAddress);
//long WINAPI UnmapViewOfFileVlm(long lpBaseAddress);
...
//long WINAPI _lopen(long lpPathName,long iReadWrite);
//long WINAPI _lcreat(long lpPathName,long iAttribute);
//long WINAPI _lread(long hFile,long lpBuffer,long uBytes);
//long WINAPI _lwrite(long hFile,long lpBuffer,long uBytes);
//long WINAPI _hread(long hFile,long lpBuffer,long lBytes);
//long WINAPI _hwrite(long hFile,long lpBuffer,long lBytes);
//long WINAPI _lclose(long hFile);
//long WINAPI _llseek(long hFile,long lOffset,long iOrigin);
...
//long WINAPI SignalObjectAndWait(long hObjectToSignal,long hObjectToWaitOn,long dwMilliseconds,long bAlertable);
...
//long WINAPI ReadFileScatter(long hFile,long aSegmentArray,long nNumberOfBytesToRead,long lpReserved,long lpOverlapped);
//long WINAPI WriteFileGather(long hFile,long aSegmentArray,long nNumberOfBytesToWrite,long lpReserved,long lpOverlapped);
...
//long WINAPI VirtualAllocVlm(long hProcess,long lpAddress,long ullSize,long flAllocationType,long flProtect);
//long WINAPI VirtualFreeVlm(long hProcess,long lpAddress,long ullSize,long dwFreeType);
//long WINAPI VirtualProtectVlm(long hProcess,long lpAddress,long ullSize,long flNewProtect,long lpflOldProtect);
//long WINAPI VirtualQueryVlm(long hProcess,long lpAddress,long lpBuffer,long dwLength);
//VOID WINAPI GlobalMemoryStatusVlm(long lpBuffer);
//long WINAPI ReadProcessMemoryVlm(long hProcess,long lpBaseAddress,long lpBuffer,long nSize,long lpNumberOfBytesRead);
//long WINAPI WriteProcessMemoryVlm(long hProcess,long lpBaseAddress,long lpBuffer,long nSize,long lpNumberOfBytesWritten);
//long WINAPI ReadFileVlm(long hFile,long lpBuffer,long nNumberOfBytesToRead,long lpReserved,long lpOverlapped);
//long WINAPI WriteFileVlm(long hFile,long lpBuffer,long nNumberOfBytesToWrite,long lpReserved,long lpOverlapped);
...
//long WINAPI QueryInformationJobObject(long hJob,long JobObjectInformationClass,long lpJobObjectInformation,long cbJobObjectInformationLength,long lpReturnLength);
//long WINAPI SetInformationJobObject(long hJob,long JobObjectInformationClass,long lpJobObjectInformation,long cbJobObjectInformationLength);
...
//API(UnmapViewOfFileVlm,kernel32)

APIA(lstrcmp,kernel32)
APIA(lstrcmpi,kernel32)
APIA(lstrlen,kernel32)
//lopen;kernel32!_lopen
//lclose;kernel32!_lclose
//lcreat;kernel32!_lcreat
//llseek;kernel32!_llseek
//lread;kernel32!_lread
//lwrite;kernel32!_lwrite
//hread;kernel32!_hread
//hwrite;kernel32!_hwrite
...
//APIA(LogonUser,kernel32)
//API(ImpersonateLoggedOnUser,kernel32)
...
//UserBSTR_free_inst;oleaut32!UserBSTR_free_inst
//UserBSTR_free_local;oleaut32!UserBSTR_free_local
//UserBSTR_from_local;oleaut32!UserBSTR_from_local
//UserBSTR_to_local;oleaut32!UserBSTR_to_local
//UserEXCEPINFO_free_inst;oleaut32!UserEXCEPINFO_free_inst
//UserEXCEPINFO_free_local;oleaut32!UserEXCEPINFO_free_local
//UserEXCEPINFO_from_local;oleaut32!UserEXCEPINFO_from_local
//UserEXCEPINFO_to_local;oleaut32!UserEXCEPINFO_to_local
//UserHWND_free_inst;oleaut32!UserHWND_free_inst
//UserHWND_free_local;oleaut32!UserHWND_free_local
//UserHWND_from_local;oleaut32!UserHWND_from_local
//UserHWND_to_local;oleaut32!UserHWND_to_local
//UserMSG_free_inst;oleaut32!UserMSG_free_inst
//UserMSG_free_local;oleaut32!UserMSG_free_local
//UserMSG_from_local;oleaut32!UserMSG_from_local
//UserMSG_to_local;oleaut32!UserMSG_to_local
//UserVARIANT_free_inst;oleaut32!UserVARIANT_free_inst
//UserVARIANT_free_local;oleaut32!UserVARIANT_free_local
//UserVARIANT_from_local;oleaut32!UserVARIANT_from_local
//UserVARIANT_to_local;oleaut32!UserVARIANT_to_local
...
//CoGetState;ole32!CoGetState
//CoGetTIDFromIPID;ole32!CoGetTIDFromIPID
...
//CoInitializeWOW;ole32!CoInitializeWOW
...
//CoUnloadingWOW;ole32!CoUnloadingWOW
...
//DllDebugObjectRPCHook;ole32!DllDebugObjectRPCHook
//DllGetClassObject;ole32!DllGetClassObject
//DllGetClassObjectWOW;ole32!DllGetClassObjectWOW
//DllRegisterServer;ole32!DllRegisterServer
//DoDragDrop;ole32!DoDragDrop
//EnableHookObject;ole32!EnableHookObject
API(FreePropVariantArray,ole32)
API(GetClassFile,ole32)
API(GetConvertStg,ole32)
//GetDocumentBitStg;ole32!GetDocumentBitStg
...
//GetHookInterface;ole32!GetHookInterface
...
//HBRUSH_UserFree;ole32!HBRUSH_UserFree
//HBRUSH_UserMarshal;ole32!HBRUSH_UserMarshal
//HBRUSH_UserSize;ole32!HBRUSH_UserSize
//HBRUSH_UserUnmarshal;ole32!HBRUSH_UserUnmarshal
//HENHMETAFILE_UserFree;ole32!HENHMETAFILE_UserFree
//HENHMETAFILE_UserMarshal;ole32!HENHMETAFILE_UserMarshal
//HENHMETAFILE_UserSize;ole32!HENHMETAFILE_UserSize
//HENHMETAFILE_UserUnmarshal;ole32!HENHMETAFILE_UserUnmarshal
//HGLOBAL_UserFree;ole32!HGLOBAL_UserFree
//HGLOBAL_UserMarshal;ole32!HGLOBAL_UserMarshal
//HGLOBAL_UserSize;ole32!HGLOBAL_UserSize
//HGLOBAL_UserUnmarshal;ole32!HGLOBAL_UserUnmarshal
//HMENU_UserFree;ole32!HMENU_UserFree
//HMENU_UserMarshal;ole32!HMENU_UserMarshal
//HMENU_UserSize;ole32!HMENU_UserSize
//HMENU_UserUnmarshal;ole32!HMENU_UserUnmarshal
//HMETAFILE_UserFree;ole32!HMETAFILE_UserFree
//HMETAFILE_UserMarshal;ole32!HMETAFILE_UserMarshal
//HMETAFILE_UserSize;ole32!HMETAFILE_UserSize
//HMETAFILE_UserUnmarshal;ole32!HMETAFILE_UserUnmarshal
//HMETAFILEPICT_UserFree;ole32!HMETAFILEPICT_UserFree
//HMETAFILEPICT_UserMarshal;ole32!HMETAFILEPICT_UserMarshal
//HMETAFILEPICT_UserSize;ole32!HMETAFILEPICT_UserSize
//HMETAFILEPICT_UserUnmarshal;ole32!HMETAFILEPICT_UserUnmarshal
...
//I_RemoteMain;ole32!I_RemoteMain
...
//UtConvertDvtd16toDvtd32;ole32!UtConvertDvtd16toDvtd32
//UtConvertDvtd32toDvtd16;ole32!UtConvertDvtd32toDvtd16
//UtGetDvtd16Info;ole32!UtGetDvtd16Info
//UtGetDvtd32Info;ole32!UtGetDvtd32Info
//WdtpInterfacePointer_UserFree;ole32!WdtpInterfacePointer_UserFree
//WdtpInterfacePointer_UserMarshal;ole32!WdtpInterfacePointer_UserMarshal
//WdtpInterfacePointer_UserSize;ole32!WdtpInterfacePointer_UserSize
//WdtpInterfacePointer_UserUnmarshal;ole32!WdtpInterfacePointer_UserUnmarshal
API(WriteClassStg,ole32)
API(WriteClassStm,ole32)
API(WriteFmtUserTypeStg,ole32)
//WriteOleStg;ole32!WriteOleStg
//WriteStringStream;ole32!WriteStringStream
